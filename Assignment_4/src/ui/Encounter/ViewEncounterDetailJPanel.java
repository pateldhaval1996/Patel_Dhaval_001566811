 ...
 */
public class ViewEncounterDetailJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private Product product;
    public ViewEncounterDetailJPanel(JPanel upc, Product p) {
        initComponents();
        userProcessContainer = upc;
        product = p;
        txtName.setText(p.getPersonName());
        txtId.setText(String.valueOf(p.getAge()));
        txtPrice.setText(String.valueOf(p.getContactNumber()));
    }
    ...
    private void initComponents() {
        ...
        lblProductPrice.setFont(new java.awt.Font("Arial Narrow", 1, 18)); // NOI18N
        lblProductPrice.setText("Contact No:");
        ...
        lblProductId.setFont(new java.awt.Font("Arial Narrow", 1, 18)); // NOI18N
        lblProductId.setText("Age:");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        product.setAge(Integer.parseInt(txtId.getText()));
        product.setContactNumber(Long.parseLong(txtPrice.getText()));
