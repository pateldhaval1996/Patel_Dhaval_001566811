...
public class ManageProductCatalogJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Manage People Catalog");

        lblSupplier.setFont(new java.awt.Font("Arial Narrow", 1, 16)); // NOI18N
        lblSupplier.setText("Supplier:");

        tblProductCatalog.setFont(new java.awt.Font("Arial Narrow", 1, 18)); // NOI18N
